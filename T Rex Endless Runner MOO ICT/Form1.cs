...
namespace T_Rex_Endless_Runner_MOO_ICT
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            scoreChart.Series.Add(new Series());
            scoreChart.Series[0].ChartType = SeriesChartType.Line;
            scoreChart.Series[0].BorderWidth = 3;
            GameReset();
            UpdateScores();
        }
        ...
        private void UpdateScores()
        {
            ...
            {
                int currentScore = Convert.ToInt32(lines[i]);
                scoreChart.Series[0].Points.AddXY(i, currentScore);
            }
        }
